        ...
        <main class="max-w-lg mx-auto mt-10 bg-blue-100 border border-blue-400 pt-10 p-20 rounded-xl">
            ...
            <form method="POST" action="/register">
                ...
                <div class="mb-6">
                    ...
                    <input class="border border-gray-400 p-2 w-full rounded-l" type="text" name="name" id="name" required>

                    <!-- username input -->
                    <label class="block mb-2 mt-4 uppercase font-bold text-xs text-gray-700" for="username">
                        username
                    </label>
                    <input class="border border-gray-400 p-2 w-full rounded-l" type="text" name="username" id="username" required>
                    ...
                    <input class="border border-gray-400 p-2 w-full rounded-l" type="email" name="email" id="email" required>
